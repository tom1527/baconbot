...
async function displayTrelloNotifications(client, notification) {
    ...
    var data = {}
    const user = notification.action.memberCreator.username;
    const card = notification.action.display.entities.card.text;
    const list = notification.action.display.entities.list.text;
